...
(define-key *group-key-map* (kbd "s-n") "gnext")
(define-key *group-key-map* (kbd "s-N") "gnext-with-window")
(define-key *group-key-map* (kbd "s-p") "gprev")
(define-key *group-key-map* (kbd "s-P") "gprev-with-window")
